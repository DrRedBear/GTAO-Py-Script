...
1. Questions regarding Python
   - Do i Need python installed to run this app?
     - YES, but only if you are going to run the app using the python file
   ...
   - do i need to install any python libraries as requirement?
...
> even though the chances of getting banned by using this app are extremely slim and nearly non-existent, it may happen if you use it unproperly or if it becomes detected in a far future, knowing that, be advised that i (the owner of this app) do not and will not take responsability for any bans caused by the use of this app, **SO USE IT AT YOUR OWN RISK**.
  - what is the purpose of this app?
   ...
   - How do i use this app?
     - you can use it by the .py file, the main executable file and the alternative executable file
        ...
        - using the main executable file:
          - 1= download the .exe file in the main executable version directory
          - 2= just double click it and run it just like you would do with any .exe file
        - using the alternative executable file:
          - 1= download the .exe file and the '_internal' folder, note that in the alternative version the .exe file must be at the same directory as the '_internal' folder and if you don't have the '_internal' folder alongside with the .exe file, the app will not run
          - 2= double click the executable and give it admin permission
      - **The alternative version is only recommended if you could not run the app with the main version**
   ...
   - Is it better to run this app through the .py file or the executable file?
     - i would say it is better to run it through the executable, more specifically the main executable version, this way you don't need to worry about any misconfiguration in your python files and also won't need to worry of having dependencies files and DLLs in the app directory, like it happpens in the alternative executable version
   - which OS and Platforms does this app works on?
     - this currently only works in windows, i'm sure that it works on windows 10 and 11, not sure about windows 7, 8 and 8.1, but windows vista and older will not work
