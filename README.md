# GTA Online Save Block Script made with Python
...
* ***OBS: if you are going to use the exe alternative version, don't forget do download the '_internals' folder and place it in the same directory as the executable, or it won't work***
\
\
